...
class CustomUser(models.Model):
    ...
    address=phone_number = models.CharField(max_length=50, null=True)
    phone_number = models.CharField(max_length=11, default=None)
...
class UserStory(models.Model):
    ...
    story_date=models.DateField(default=datetime.now(),null=True)

    def __str__(self):
        return str(self.user.user.username) + "/" + str(self.story) + "/" + str(self.story_title)
